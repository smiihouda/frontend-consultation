...
class UpdatePsy extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit = () => {
    ...
    axios.put("http://127.0.0.1:9000/psy/modify", {
      Id: this.state.Id,
            ...
            <Row>
              <Col xs="12" sm="12" md="12">
                <Card>
                  <CardBody>
                    <form>
                      <h1 className="h1 text-center text-success font-weight-bold">Update Psy</h1>
                      <hr></hr>
                      <div className="row">
                        <div className="col-md-6">
                          <div className="form-group">
                            ...
                            <input type="text" name="firstname" id="firstname" className="form-control"
                             value={this.state.Firstname} placeholder="" aria-describedby="helpId" onChange={this.handleChange} />
...
const mapStateToProps = (state) => {
  return {
    psy: state.psyReducer
  }

}
const mapDispatchToProps = (dispatch) => {
  return {
    PatientInfoReducer: psy => {
      dispatch({
        type: 'PSY_INFO',
        psy
      })
...
export default connect(mapStateToProps, mapDispatchToProps)(UpdatePsy);
