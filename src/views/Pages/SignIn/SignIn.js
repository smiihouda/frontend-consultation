...
class SignIn extends Component {
 ...
 // else {
 /* axios
 .post(process.env.REACT_APP_BACKEND_HOST+':'+process.env.REACT_APP_BACKEND_PORT+'/patient/login', {
 ...
 this.props.history.push('/patient/profil');
 }
 } else {
 ...
 <div class="home">
 <div class="background_image bckpatt" ></div>
